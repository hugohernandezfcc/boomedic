             ...
             $blocker = array();
                    ...
                    if($labor->specialty == 'Médico General'){
                        ...
                        if(!$labor->profile_photo){
                            $mg[] = json_encode(array($labor->latitude, $labor->longitude, $labor->name, $labor->workplace, $labor->general_amount, $workArray, $labor->id, $labor->dr, $cite, "{{ asset(config(marker-doc)) }}", $blocker)); 
                        } else{
                        ...
                        if(!$labor->profile_photo){
                            $it[] = json_encode(array($labor->specialty, $labor->latitude, $labor->longitude, $labor->name, $labor->workplace, $labor->general_amount, $workArray, $labor->id, $labor->dr, $cite, "{{ asset(config(marker-doc)) }}", $blocker));
                          } 
                        else{
