                    ...
                    $attach = $this->imapPop3->attachment($mbox, $user->id);
                           ...
                           if(count($result2) > 0){
                            foreach($result2 as $mail){
                                array_push($array, ['type' => 'correo', 'title' => $mail->subject_email, 'name' => $mail->email, 'profile_photo' => 'https://icon-icons.com/icons2/936/PNG/512/inbox_icon-icons.com_73527.png', 'created_at' => $mail->created_at]);
                              }
                           } 
