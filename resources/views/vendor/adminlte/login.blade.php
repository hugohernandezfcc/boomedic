                                       ...
                                       if(result.length > 0){
                                        ...
                                        for(var z =0; z < result.length; z++){
                                         ...
                                         /*   $('.formfast').append('<a href="'+ urll +'/'+ result[z]['idu'] +'"><div class="widget-user-header" style="background: #2f2f2f;"><div class="widget-user-image"><img class="img-circle" src="'+ photo +'" alt="User Avatar" style="width: 35px !important;"></div><h4 class="widget-user-desc">'+ result[z]['name'] +'</h3></div></a>');*/
                                            ...
                                            $('.formfast').append('<div style="margin-bottom: 5px;"><div class="lockscreen-item"><div class="lockscreen-image"><img src="'+ photo +'" alt="User Image"></div><form class="lockscreen-credentials"><div class="input-group"><a href="'+ urll +'/'+ result[z]['idu'] +'" class="text-muted"><label>'+ result[z]['name'] +'</label><i class="fa fa-arrow-right text-muted"></i></a></div></form></div></div><br>');
                                         }
                                        }
                                      }
                                    })
