                                       ...
                                       if(result.length > 0){
                                        ...
                                        for(var z =0; z < result.length; z++){
                                         ...
                                         /*   $('.formfast').append('<a href="'+ urll +'/'+ result[z]['idu'] +'"><div class="widget-user-header" style="background: #2f2f2f;"><div class="widget-user-image"><img class="img-circle" src="'+ photo +'" alt="User Avatar" style="width: 35px !important;"></div><h4 class="widget-user-desc">'+ result[z]['name'] +'</h3></div></a>');*/
                                            ...
                                            $('.formfast').append('<a href="'+ urll +'/'+ result[z]['idu'] +'" class="text-muted" style="display:block; color: white !important;"><div class="lockscreen-item" style="position:relative !important; margin: 10px auto 36px auto !important; background: #333 !important;"><div class="lockscreen-image" style="background:#333 !important;"><img src="'+ photo +'" alt="User Image"></div><form class="lockscreen-credentials"><div class="input-group"><label>'+ result[z]['name'] +'</label>&nbsp;<i class="fa fa-arrow-right pull-right"></i></div></form></div></a><br>');
                                         }
                                        }
                                      }
                                    })
