                 ...
                 var com = "{{ session()->get('entered') }}";
                    ...
                    $('#notify').html('');
                      if(result[1].length > 0){  
                          ...
                          $('#notify').append('<li><a class="pointer" data-toggle="modal" data-target="#modalmedications"><i class="fa fa-warning text-yellow"></i>Tienes un tratamiento por iniciar</a></li>');
