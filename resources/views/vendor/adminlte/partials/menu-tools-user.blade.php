                                                                ...
                                                                $('#allmed').append('<li class="time-label"><span class="bg-gray">'+ moment(date).format("DD-MM-YYYY") +'</span></li>');
                                                                   for(var z = 0; z < result[date].length; z++){
                                                                    ...
                                                                    if(result[date][z]['active'] == 'Confirmed'){
                                                                      $('#treatmenttool').append('<div class="modal fade" role="dialog" id="'+ result[date][z]['id'] +'"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header" ><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><div align="left"><label>Tratamiento en curso</label></div></div><div class="modal-body"><div class="box box-primary"><div class="box-header with-border"><b>'+ result[date][z]['name_medicine'] +'</b></div><div class="box-body">Posología: <span class="text-muted">'+ result[date][z]['frequency_days'] +'día(s), ' + result[date][z]['posology']+'</span><br/>Fecha y hora de inicio: <span class="text-muted">'+ result[date][z]['start_date'] +'</span><br/>Próxima dosis: <span class="text-muted"></span></div></div></div></div></div></div>')
