                ...
                <div class="navbar-custom-menu">
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown user user-menu">
                                ...
                                <a href="{{ url(config('adminlte.logout_url', 'auth/logout')) }}" class="btn btn-default btn-block btn-flat" style="background:white;">
                                    <i class="fa fa-sign-out"></i> {{ trans('adminlte::adminlte.log_out') }}
                                </a>
                            @else
                                <a href="#"
                                   onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                 class="btn btn-default btn-block btn-flat" style="background:white;">
                                    <i class="fa fa-sign-out"></i> {{ trans('adminlte::adminlte.log_out') }}
                                </a>
