...
<div class="box">
	  		<div class="alert alert-info" style="background-color: #222d32 !important; border-color: #222d32 !important">
		        <h5><i class="icon fa fa-info"></i>Bienvenido a Boomedic {{ $name }}, solo te faltan algunos pasos más. Confirma tu nueva cuenta con el enlace que fue enviado a tu correo para continuar.</h5><br>
        <div>
