						 ...
						 <div class="col-sm-10">
						 	<div class="input-group">
						    	<div class="input-group-btn">
						        	...
						        	<ul class="dropdown-menu">
						          		<li><a href="javascript:void(0);" onclick="setInField('temperature', 'Oral');" >Oral</a></li>
						          		<li><a href="javascript:void(0);" onclick="setInField('temperature', 'Axilar');" >Axilar</a></li>
						          		<li><a href="javascript:void(0);" onclick="setInField('temperature', 'Rectal');" >Rectal</a></li>
						          		<li><a href="javascript:void(0);" onclick="setInField('temperature', 'Frontal');" >Frontal</a></li>
						        	</ul>
						      	</div>
