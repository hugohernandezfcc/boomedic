    ...
    <div class="box">
	  	...
	  	<div class="box-body">
	  		@if( !empty($status) )
	    		...
	    		<div class="col-sm-4" align="center" style="width:350px; height: 230px; "><form enctype="multipart/form-data" action="/user/updateProfile/{{$userId}}" method="post" class="dropzone" id="myAwesomeDropzone"></form></div></div><br/>
