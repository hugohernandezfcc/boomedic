...
@section('content')
	<script type="text/javascript" src="{{ URL::asset('public/js/jquery.Jcrop.min.js') }}"></script>
	<script type="text/javascript" src="{{ URL::asset('public/js/jquery.color.js') }}"></script>
	<script type="text/javascript" src="{{ URL::asset('public/js/jquery.Jcrop.js') }}"></script>
