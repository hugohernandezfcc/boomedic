...
@section('content')
	<div class="row">
        ...
        <!-- ./col -->
            ...
            <input type="button" class="btn btn-default" onclick="location.href='boomedic://';" value="Boomedic custom link" />

            <input type="button" class="btn btn-default" onclick="location.href='whatsapp://';" value="Whatsapp" />
