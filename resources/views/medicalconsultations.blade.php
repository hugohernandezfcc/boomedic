...
@section('content')
  ...
  <script type="text/javascript">
    ...
    var datos = [
          @foreach 
              ["{{ $labor->professional_information->specialty }}","{{ $labor->labor_information->latitude }}","{{ $labor->labor_information->longitude }}", "{{ $labor->users->name }}", "{{ $labor->labor_information->workplace }}"],
          @endforeach
