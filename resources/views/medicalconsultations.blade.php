...
@section('content')
  ...
  <script type="text/javascript">
    ...
    var specialities = [@php foreach(session()->get('sp') as $sp){ $sp[] = $sp; } echo implode(',', array_unique($sp)); @endphp  ["Alergología"], ["Cardiología"], ["Gastroenterología"], ["Geriatría"], ["Infectología"], ["Neumología"], ["Neurología"], ["Nutriología"], ["Oftalmología"], ["Oncología"], ["Pediatría"], ["Psiquiatría"], ["Rehabilitación"], ["Reumatología"], ["Toxicología"], ["Odontología"]];
