...
<div align="center" class="col-sm-12 enun">
	<img src="{{ asset(config('adminlte.empty-box')) }}" height="200" width="200" id="imgEmpty">
	<h3>OMG!</h3>
	<h4> 
		<span class="spanEmpty1"> No tienes {{ $title }} agregados </span>
		<span class="spanEmpty">, <br> podrías generar tu primer registro aquí</span>
	</h4>
