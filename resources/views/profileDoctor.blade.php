						 ...
						 <span class="text-black">No hay ningún centro asociado a su cuenta...</span>			
							...
							<div class="col-sm-8" style="padding-right: 0; padding-left: 0;">
									          <div class="info-box sm bg-gray">
									          	<a href="{{ url('workboard/index') }}/{{$labor->id}}"><span class="info-box-icon sm bg-secondary"><i class="fa fa-calendar-plus-o"></i></span></a>
						...
						<div class="form-group">
							<div class="col-sm-8" style="padding-right: 0; padding-left: 0;">
					          <div class="info-box bg-gray">
					          	<a href="{{ url('workboard/index') }}/{{$labor->id}}"><span class="info-box-icon bg-secondary"><i class="fa fa-calendar-plus-o"></i></span></a>
