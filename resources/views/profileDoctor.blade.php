						...
						@if($loop->iteration < 3)
							<div class="col-sm-12">
					          <div class="info-box sm bg-gray">
					            ...
					            <div align="right"><a href = "{{ url('doctor/delete') }}/{{ $labor->id }}" class="btn" onclick ="return confirm('¿Seguro desea eliminar este lugar?')"><i class="fa fa-trash text-muted"></i></a></div>
					            </div>
