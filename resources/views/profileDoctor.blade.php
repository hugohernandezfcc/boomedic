                  ...
                  <div id="collapseThree" class="panel-collapse collapse in" aria-labelledby="headingThree">
                    <div class="box-body">
						 ...
						 <span class="text-black">No hay ningún centro asociado a su cuenta.</span>			
							...
							<img border="0" src="//maps.googleapis.com/maps/api/staticmap?center={{ $labor->latitude }},{{ $labor->longitude }}&amp;markers=size:small%7Ccolor:black%7Clabel:%7C{{ $labor->latitude }},{{ $labor->longitude }}&amp;zoom=15&amp;size=400x45&amp;key=AIzaSyCKh6YcZQgwbcbUBCftcAQq7rfL5bLW_6g" alt="ubicación"  style="width:100%; height:45px;">	
							</div>
							</div>		
							@endforeach
							@endif
			...
			@if($mode == 'viewlabor')
				...
				@foreach($labor->sortByDesc('created_at') as $labor)	
						...
						<div class="pull-center">
					        ...
					        <div class="col-sm-4" style="padding-right: 0; padding-left: 0;">
							<img border="0" src="//maps.googleapis.com/maps/api/staticmap?center={{ $labor->latitude }},{{ $labor->longitude }}&amp;markers=small%7Ccolor:black%7Clabel:%7C{{ $labor->latitude }},{{ $labor->longitude }}&amp;zoom=15&amp;size=400x90&amp;key=AIzaSyCKh6YcZQgwbcbUBCftcAQq7rfL5bLW_6g" alt="ubicación"  style="width:100%; height: 91px;">	
							</div>
						</div>  
